...
#Working
1.Getting the string input from the user.
2.Converting it to uppercase and finding the corresponding morse code.
3.If it is a dot, the LED blinks for 200s.
4.Else, it blinks for 600s.
#Working
1.
